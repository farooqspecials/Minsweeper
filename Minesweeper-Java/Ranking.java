...
public class Ranking{
	...
	private int[] record;
	private int last;
	//ranking function explaining the ranking of players
	Ranking(){
	...
	public void recordName(int result) {
		...
		//initiate sort method
		sort();
		//initiate show method
		show();
	}
	...
	private void sort(){
		...
		while(unsorted){
			...
			for(int i=0;i<(last-1);i++){
				unsorted = sortRecord(unsorted, i);
			}
		}
	}

	//SortRecord method called in Sort
	private boolean sortRecord(boolean unsorted, int i) {
